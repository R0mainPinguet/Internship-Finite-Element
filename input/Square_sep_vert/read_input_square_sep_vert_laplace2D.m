...
if ~(exist("mshfile")==1)
    ...
    %=== Default input file ===%
    mshfile='Square_sep_vert_0bis.msh';
    %==========================%
...
%= ANALYSIS TYPE
% 12 -> 2D_Laplacien, champ de vecteur a \Delta \uVec + b \uVec = \fVec
analysis.type = 12;
...
if ~(exist("material")==1)
    ...
    for i_mat=1:length(material(:,1))
        disp("Material ("+num2str(i_mat)+") : mu = "+num2str(material(i_mat,1)) );
    end
    disp("#####");
end
%==========================%
