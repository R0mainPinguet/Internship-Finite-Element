...
elseif uex=="testContinu"
    ...
    cbc = [7 1 2 "(l2-l1)*(-x)*[1 0;0 1]+2*(m2-m1)*[0 0;0 -x]"];

elseif uex=="testContinu2"
    
    dbc = [3 1 "y*y/2";3 2 "y/3";
           4 1 "x*x/2";4 2 "x*x*x/3";
           5 1 "y*y/2";5 2 "-y/3";
           6 1 "x*x/2";6 2 "-x*x*x/3"];
    
    cbc = [7 1 2 "(l2-l1)*(x*y*y-x*x*x/3)*[1 0;0 1] + 2*(m2-m1)*[x*y*y 0;0 -x*x*x/3]"];
